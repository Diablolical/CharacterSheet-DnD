  ...
  return(
        ...
        >
            ...
            <div className="options">
                ...
                <div className="row">
                    <button title="Add damage type" className="flatButton plusButton" onClick={(e) => { e.preventDefault(); addDamageType(); }}>+</button>
                </div>
            </div>
            <div className="row saveRow">
                <button id="modalSave" className="flatButton" onClick={(e) => { e.preventDefault(); saveAttack(weapon); }}>Save</button>
            </div>
