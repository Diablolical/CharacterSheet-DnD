...
function WeaponModal({ isOpen, toggleClose, attributes, proficiencyBonus, weaponData, saveWeapon }) {
    ...
    return(
        ...
        >
            ...
            <div className="options">
                ...
                <div className="row">
                    <label>Attack:</label>
                    <select name="attackAttr" onChange={(e) => {handleAttrSelect(e.target.value)}} value={attrSelected.name}>
                ...
                <div className="row">
                    <button onClick={(e) => { e.preventDefault(); addDamageType(); }}>Add Damage Type</button>
                </div>
            </div>
            <div className="row">
                <button onClick={(e) => { e.preventDefault(); saveWeapon(weapon); }}>Save</button>
            </div>
